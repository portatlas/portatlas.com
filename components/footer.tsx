    ...
    return (
        <footer className={styles.footerContainer}>
            <ul className={styles.iconContainer}>
                <li>
                    <a
                        href="https://www.instagram.com/portatlas/"
                        target="blank"
                ...
                <li>
                    <a
                        href="https://twitter.com/portatlas"
                        target="blank"
                        rel="noopener noreferrer"
                ...
                <li>
                    <a
                        href="https://soundcloud.com/portatlas"
                        target="blank"
                        rel="noopener noreferrer"
                ...
                <li>
                    <a
                        href="https://github.com/portatlas"
                        target="blank"
                        rel="noopener noreferrer"
                ...
                <li>
                    <a
                        href="https://www.linkedin.com/in/avathanaka/"
                        target="blank"
                        rel="noopener noreferrer"
